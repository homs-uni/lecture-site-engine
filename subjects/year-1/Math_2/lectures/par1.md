...
**الشرح:**
> ⚠️ الصيغ الثلاث الأخيرة منقولة حرفياً كما وردت في المحاضرة الأصلية — راجع ملاحظة التدقيق في نهاية القسم
...
| removable | نقطة انقطاع قابلة للإزالة | 1 | نتيجة | النهايتان متساويتان لكن $\neq f(x_0)$ |
...
| --- | --- | --- | --- |
| root | second_kind | إحدى النهايتين غير موجودة/غير محدودة | مثال: $\lim_{x\to0^{-}} = -1$ ، $\lim_{x\to0^{+}} = +\infty$ |
| root | removable | النهايتان موجودتان، متساويتان، لكن $\neq f(x_0)$ | مثال: $\lim = 2$ ، $f(0) = 0$ |
